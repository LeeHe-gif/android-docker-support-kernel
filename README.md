...
- **基于 [kirin970-kernel-based-on-emui9.1](https://opensource.ztedevices.com](https://github.com/LeeHe-gif/kirin970-kernel-based-on-emui9.1)** 源码构建 华为nova3 内核，开启docker支持可以开机，正在测试docker功能中。
## ✅ Docker 支持状态
